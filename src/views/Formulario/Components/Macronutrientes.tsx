...
const Macronutrientes = () => {
  const {
    ...
    tipoPrescripcion,
    flujoMetabolico,
    handleFlujoMetabolico,
    messageErrorFlujoMetabolico,
    aminoacidos,
    handleAminoacidos,
    tipoDextrosa,
    handleTipoDextrosa,
    dextrosa,
    handleDextrosa,
    messageErrorDextrosa,
    requerimientoAminoacidos,
    handleRequerimientoAminoacidos,
    messageErrorRequerimientoAminoacidos,
    lipidos,
    handleLipidos,
    requerimientoLipidos,
    handleRequerimientoLipidos,
    omegaven,
    handleOmegaven,
    dipeptiven,
    handleDipeptiven,
  ...
  const getDextrosaByFlujo = (flujo: string) => {
    ...
    const result = (parseFloat(flujo) * ((tiempoDeInfucion * 60) / 1000))
      .toFixed(2)
      .toString();
    ...
    >
      ...
      <Grid container direction="column">
        ...
        <Box display="flex" sx={{ marginTop: "20px" }}>
          <Grid container>
            <LightTooltip
              title="Seleccione el tipo de dextrosa"
              placement="top"
              arrow
            >
              <Grid item xs={12} sm={6} md={6} style={{ padding: "10px" }}>
                <CustomTextField
                  onChange={handleTipoDextrosa}
                  onClick={getPrescriptions}
                  onKeyPress={getPrescriptions}
                  value={tipoDextrosa}
                  defaulValue={tipoDextrosa}
                  id="tipoDextrosa"
                  label="Tipo de dextrosa*"
                  type="text"
                  select={true}
                >
                  {tipo_dextrosa.map((option) => (
                    <MenuItem
            ...
            <Grid item xs={12} sm={6} md={6} style={{ padding: "10px" }}></Grid>
          </Grid>
        </Box>
        <Box display="flex" sx={{ marginTop: "20px" }}>
          <Grid container>
